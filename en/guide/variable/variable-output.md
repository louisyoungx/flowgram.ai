...
Private variables are variables that can only be accessed within the current node and its child nodes. (See also: [Node Private Scope](/en/guide/variable/concept.md#node-private-scope))
