...
Refer to [Type Management](/en/materials/common/json-schema-preset.md) to configure constant inputs when registering types
...
ConstantInput is deeply integrated with [**Material Type Management**](/en/materials/common/json-schema-preset.md):
