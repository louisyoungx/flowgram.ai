...
`BatchOutputs` must be used with [batchOutputsPlugin](/en/materials/form-plugins/batch-outputs-plugin.md) to work properly. This is because:
...
| **BatchOutputs** + [batchOutputsPlugin](/en/materials/form-plugins/batch-outputs-plugin.md) | Component + Plugin | Configure loop outputs and generate array-type variables |
...
* [provideBatchInputEffect](/en/materials/effects/provide-batch-input.md): Loop input variable parsing effect
