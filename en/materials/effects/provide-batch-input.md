...
| [BatchOutputs](/en/materials/components/batch-outputs.md) + [batchOutputsPlugin](/en/materials/form-plugins/batch-outputs-plugin.md) | Component + Plugin | Configure loop outputs and generate array-type variables |
...
See: [Node Private Scope](/en/guide/variable/concept.md#node-private-scope)
...
`provideBatchInputEffect` uses the [`createEffectFromVariableProvider`](/en/guide/variable/variable-output.md) factory function to create a variable provider. Key characteristics:
...
See: [Variable Concepts - Expressions](/en/guide/variable/concept.md#expressions)
...
* [BatchVariableSelector](/en/materials/components/batch-variable-selector.md): Array variable selector for selecting loop input
* [BatchOutputs](/en/materials/components/batch-outputs.md): Loop output configuration component
* [batchOutputsPlugin](/en/materials/form-plugins/batch-outputs-plugin.md): Loop output plugin, handles scope chain and type inference
