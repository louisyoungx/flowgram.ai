...
|------|------|------|
| [BatchVariableSelector](/en/materials/components/batch-variable-selector.md) | Component | Select the array data source for the loop |
| [provideBatchInputEffect](/en/materials/effects/provide-batch-input.md) | Effect | Generate `item` and `index` local variables |
| [BatchOutputs](/en/materials/components/batch-outputs.md) + **batchOutputsPlugin** | Component + Plugin | Configure loop outputs and generate array-type variables |
...
In the default scope chain logic (refer to [Scope Chain Concept](/en/guide/variable/concept.md#scope-chain)):
...
[**BatchOutputs**](/en/materials/components/batch-outputs.md)

* Loop output configuration component for collecting output key-value pairs

[**BatchVariableSelector**](/en/materials/components/batch-variable-selector.md)

* Array variable selector for selecting loop input

[**provideBatchInputEffect**](/en/materials/effects/provide-batch-input.md)
...
* [provideBatchInputEffect](/en/materials/effects/provide-batch-input.md): Loop input variable parsing
* [BatchOutputs](/en/materials/components/batch-outputs.md): Loop output configuration component
* [BatchVariableSelector](/en/materials/components/batch-variable-selector.md): Array variable selector
* [inferInputsPlugin](/en/materials/form-plugins/infer-inputs-plugin.md): Input parameter Schema inference plugin
