...
* [defaultValues](/en/auto-docs/editor/interfaces/FormMeta.md#defaultvalues)
* [effect](/en/auto-docs/editor/interfaces/FormMeta.md#effect)
* [formatOnInit](/en/auto-docs/editor/interfaces/FormMeta.md#formatoninit)
* [formatOnSubmit](/en/auto-docs/editor/interfaces/FormMeta.md#formatonsubmit)
* [plugins](/en/auto-docs/editor/interfaces/FormMeta.md#plugins)
* [render](/en/auto-docs/editor/interfaces/FormMeta.md#render)
* [validate](/en/auto-docs/editor/interfaces/FormMeta.md#validate)
* [validateTrigger](/en/auto-docs/editor/interfaces/FormMeta.md#validatetrigger)
...
`Optional` **effect**: `Record`<`string`, [`EffectOptions`](/en/auto-docs/editor/types/EffectOptions.md)\[]>
...
`Optional` **plugins**: [`FormPlugin`](/en/auto-docs/editor/classes/FormPlugin.md)<`any`>\[]
...
**render**: (`props`: [`FormRenderProps`](/en/auto-docs/editor/interfaces/FormRenderProps.md)<`any`>) => `ReactElement`<`any`, `string` | `JSXElementConstructor`<`any`>>
...
| Name | Type |
| :------ | :------ |
| `props` | [`FormRenderProps`](/en/auto-docs/editor/interfaces/FormRenderProps.md)<`any`> |
...
`Optional` **validateTrigger**: [`ValidateTrigger`](/en/auto-docs/editor/enums/ValidateTrigger.md)
