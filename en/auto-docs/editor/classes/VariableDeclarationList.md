...
* [`ASTNode`](/en/auto-docs/editor/classes/ASTNode.md)<[`VariableDeclarationListJSON`](/en/auto-docs/editor/interfaces/VariableDeclarationListJSON.md)>
...
* [constructor](/en/auto-docs/editor/classes/VariableDeclarationList.md#constructor)

### Properties

* [changeLocked](/en/auto-docs/editor/classes/VariableDeclarationList.md#changelocked)
* [declarationTable](/en/auto-docs/editor/classes/VariableDeclarationList.md#declarationtable)
* [declarations](/en/auto-docs/editor/classes/VariableDeclarationList.md#declarations)
* [flags](/en/auto-docs/editor/classes/VariableDeclarationList.md#flags)
* [key](/en/auto-docs/editor/classes/VariableDeclarationList.md#key)
* [onDispose](/en/auto-docs/editor/classes/VariableDeclarationList.md#ondispose)
* [opts](/en/auto-docs/editor/classes/VariableDeclarationList.md#opts)
* [parent](/en/auto-docs/editor/classes/VariableDeclarationList.md#parent)
* [scope](/en/auto-docs/editor/classes/VariableDeclarationList.md#scope)
* [toDispose](/en/auto-docs/editor/classes/VariableDeclarationList.md#todispose)
* [value$](/en/auto-docs/editor/classes/VariableDeclarationList.md#value$)
* [kind](/en/auto-docs/editor/classes/VariableDeclarationList.md#kind)

### Accessors

* [children](/en/auto-docs/editor/classes/VariableDeclarationList.md#children)
* [disposed](/en/auto-docs/editor/classes/VariableDeclarationList.md#disposed)
* [hash](/en/auto-docs/editor/classes/VariableDeclarationList.md#hash)
* [kind](/en/auto-docs/editor/classes/VariableDeclarationList.md#kind-1)
* [version](/en/auto-docs/editor/classes/VariableDeclarationList.md#version)

### Methods

* [dispatchGlobalEvent](/en/auto-docs/editor/classes/VariableDeclarationList.md#dispatchglobalevent)
* [dispose](/en/auto-docs/editor/classes/VariableDeclarationList.md#dispose)
* [fireChange](/en/auto-docs/editor/classes/VariableDeclarationList.md#firechange)
* [fromJSON](/en/auto-docs/editor/classes/VariableDeclarationList.md#fromjson)
* [subscribe](/en/auto-docs/editor/classes/VariableDeclarationList.md#subscribe)
* [toJSON](/en/auto-docs/editor/classes/VariableDeclarationList.md#tojson)
...
**declarationTable**: `Map`<`string`, [`VariableDeclaration`](/en/auto-docs/editor/classes/VariableDeclaration.md)<`any`>>
...
**declarations**: [`VariableDeclaration`](/en/auto-docs/editor/classes/VariableDeclaration.md)<`any`>\[]
...
| Name | Type |
| :------ | :------ |
| `«destructured»` | [`VariableDeclarationListJSON`](/en/auto-docs/editor/interfaces/VariableDeclarationListJSON.md)<`any`> |
...
| Name | Type |
| :------ | :------ |
| `Data` | [`VariableDeclarationList`](/en/auto-docs/editor/classes/VariableDeclarationList.md) |
...
| `selector?` | `SubscribeConfig`<[`VariableDeclarationList`](/en/auto-docs/editor/classes/VariableDeclarationList.md), `Data`> | Listens for specified data. |
