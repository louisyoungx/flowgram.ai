...
**keyType**: [`BaseType`](/en/auto-docs/editor/classes/BaseType.md)<`any`, `any`>
...
**valueType**: [`BaseType`](/en/auto-docs/editor/classes/BaseType.md)<`any`, `any`>
...
| `selector?` | `SubscribeConfig`<[`MapType`](/en/auto-docs/editor/classes/MapType.md), `Data`> | 监听指定数据 |
