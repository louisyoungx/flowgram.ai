...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`CustomTypeJSON`](/en/auto-docs/editor/interfaces/CustomTypeJSON.md) | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`CustomType`](/en/auto-docs/editor/classes/CustomType.md), `Data`> | 监听指定数据 |
