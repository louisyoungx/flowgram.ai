...
| :------ | :------ | :------ |
| `«destructured»` | [`WrapArrayExpressionJSON`](/en/auto-docs/editor/interfaces/WrapArrayExpressionJSON.md) | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`WrapArrayExpression`](/en/auto-docs/editor/classes/WrapArrayExpression.md), `Data`> | 监听指定数据 |
