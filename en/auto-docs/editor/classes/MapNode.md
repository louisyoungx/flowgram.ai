...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`MapNodeJSON`](/en/auto-docs/editor/interfaces/MapNodeJSON.md) | AST JSON 数据 |
...
**get**(`key`): `undefined` | [`ASTNode`](/en/auto-docs/editor/classes/ASTNode.md)<`any`, `any`>
...
| `nextJSON` | [`ASTNodeJSON`](/en/auto-docs/editor/interfaces/ASTNodeJSON.md) | - |
...
| `selector?` | `SubscribeConfig`<[`MapNode`](/en/auto-docs/editor/classes/MapNode.md), `Data`> | 监听指定数据 |
