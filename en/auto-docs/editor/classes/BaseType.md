...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseType`](/en/auto-docs/editor/classes/BaseType.md)<`JSON`> |
...
| `selector?` | `SubscribeConfig`<[`BaseType`](/en/auto-docs/editor/classes/BaseType.md)<`JSON`>, `Data`> | Listens for specified data. |
