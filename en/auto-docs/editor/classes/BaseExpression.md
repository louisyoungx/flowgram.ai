...
* [`ASTNode`](/en/auto-docs/editor/classes/ASTNode.md)<`JSON`, `InjectOpts`>
  ...
  ↳↳ [`KeyPathExpressionV2`](/en/auto-docs/editor/classes/KeyPathExpressionV2.md)
...
| `selector?` | `SubscribeConfig`<[`BaseExpression`](/en/auto-docs/editor/classes/BaseExpression.md)<`JSON`, `InjectOpts`>, `Data`> | 监听指定数据 |
