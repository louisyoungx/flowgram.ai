...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseType`](/en/auto-docs/variable-core/classes/BaseType.md)<`JSON`> |
...
| `selector` | `SubscribeConfig`<[`BaseType`](/en/auto-docs/variable-core/classes/BaseType.md)<`JSON`>, `Data`> | Listens for specified data. |
