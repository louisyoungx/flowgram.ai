...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`ListNodeJSON`](/en/auto-docs/variable-core/interfaces/ListNodeJSON.md) | AST JSON 数据 |
...
| `selector` | `SubscribeConfig`<[`ListNode`](/en/auto-docs/variable-core/classes/ListNode.md), `Data`> | 监听指定数据 |
