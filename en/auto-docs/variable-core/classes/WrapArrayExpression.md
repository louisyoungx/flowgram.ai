...
| :------ | :------ | :------ |
| `«destructured»` | [`WrapArrayExpressionJSON`](/en/auto-docs/variable-core/interfaces/WrapArrayExpressionJSON.md) | AST JSON 数据 |
...
| `selector` | `SubscribeConfig`<[`WrapArrayExpression`](/en/auto-docs/variable-core/classes/WrapArrayExpression.md), `Data`> | 监听指定数据 |
