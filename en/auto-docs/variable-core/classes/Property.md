...
* [dispatchGlobalEvent](/en/auto-docs/variable-core/classes/Property.md#dispatchglobalevent)
...
| `selector` | `SubscribeConfig`<[`Property`](/en/auto-docs/variable-core/classes/Property.md)<`VariableMeta`>, `Data`> | 监听指定数据 |
