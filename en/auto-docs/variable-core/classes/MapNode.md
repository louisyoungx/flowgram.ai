...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`MapNodeJSON`](/en/auto-docs/variable-core/interfaces/MapNodeJSON.md) | The `MapNodeJSON` to deserialize. |
...
| Name | Type |
| :------ | :------ |
| `Node` | extends [`ASTNode`](/en/auto-docs/variable-core/classes/ASTNode.md)<`any`, `Node`> = [`ASTNode`](/en/auto-docs/variable-core/classes/ASTNode.md)<`any`> |
...
| :------ | :------ | :------ |
| `key` | `string` | The key of the node. |
| `nextJSON` | [`ASTNodeJSON`](/en/auto-docs/variable-core/interfaces/ASTNodeJSON.md) | The JSON representation of the node. |
...
| `selector` | `SubscribeConfig`<[`MapNode`](/en/auto-docs/variable-core/classes/MapNode.md), `Data`> | Listens for specified data. |
...
| `map` | \[`string`, [`ASTNode`](/en/auto-docs/variable-core/classes/ASTNode.md)<`any`>]\[] |
