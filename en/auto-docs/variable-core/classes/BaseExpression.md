...
* [`ASTNode`](/en/auto-docs/variable-core/classes/ASTNode.md)<`JSON`>
...
`Abstract` **returnType**: `undefined` | [`BaseType`](/en/auto-docs/variable-core/classes/BaseType.md)<`any`>
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseExpression`](/en/auto-docs/variable-core/classes/BaseExpression.md)<`JSON`> |
...
| `selector` | `SubscribeConfig`<[`BaseExpression`](/en/auto-docs/variable-core/classes/BaseExpression.md)<`JSON`>, `Data`> | Listens for specified data. |
