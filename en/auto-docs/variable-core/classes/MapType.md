...
**keyType**: [`BaseType`](/en/auto-docs/variable-core/classes/BaseType.md)<`any`>
...
**valueType**: [`BaseType`](/en/auto-docs/variable-core/classes/BaseType.md)<`any`>
...
| `selector` | `SubscribeConfig`<[`MapType`](/en/auto-docs/variable-core/classes/MapType.md), `Data`> | Listens for specified data. |
