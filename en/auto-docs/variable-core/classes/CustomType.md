...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`CustomTypeJSON`](/en/auto-docs/variable-core/interfaces/CustomTypeJSON.md) | The `CustomTypeJSON` to deserialize. |
...
| `selector` | `SubscribeConfig`<[`CustomType`](/en/auto-docs/variable-core/classes/CustomType.md), `Data`> | Listens for specified data. |
