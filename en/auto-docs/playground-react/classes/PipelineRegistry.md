...
`Readonly` **onResize**: [`Event`](/en/auto-docs/playground-react/interfaces/Event-1.md)<[`PipelineDimension`](/en/auto-docs/playground-react/interfaces/PipelineDimension.md)>
