...
* [defaultValues](/en/auto-docs/node/interfaces/FormMeta.md#defaultvalues)
* [effect](/en/auto-docs/node/interfaces/FormMeta.md#effect)
* [formatOnInit](/en/auto-docs/node/interfaces/FormMeta.md#formatoninit)
* [formatOnSubmit](/en/auto-docs/node/interfaces/FormMeta.md#formatonsubmit)
* [plugins](/en/auto-docs/node/interfaces/FormMeta.md#plugins)
* [render](/en/auto-docs/node/interfaces/FormMeta.md#render)
* [validate](/en/auto-docs/node/interfaces/FormMeta.md#validate)
* [validateTrigger](/en/auto-docs/node/interfaces/FormMeta.md#validatetrigger)
...
`Optional` **effect**: `Record`<`string`, [`EffectOptions`](/en/auto-docs/node/types/EffectOptions.md)\[]>
...
`Optional` **plugins**: [`FormPlugin`](/en/auto-docs/node/classes/FormPlugin.md)<`any`>\[]
...
`Optional` **validate**: `Record`<`string`, [`Validate`](/en/auto-docs/node/types/Validate.md)<`any`, `any`>> | (`values`: `TValues`, `ctx`: `NodeFormContext`) => `Record`<`string`, [`Validate`](/en/auto-docs/node/types/Validate.md)<`any`, `any`>>
