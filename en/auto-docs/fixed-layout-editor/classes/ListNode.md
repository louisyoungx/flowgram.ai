...
* [`ASTNode`](/en/auto-docs/fixed-layout-editor/classes/ASTNode.md)<[`ListNodeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/ListNodeJSON.md)>
...
* [constructor](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#constructor)

### Properties

* [changeLocked](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#changelocked)
* [flags](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#flags)
* [key](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#key)
* [onDispose](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#ondispose)
* [opts](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#opts)
* [parent](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#parent)
* [scope](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#scope)
* [toDispose](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#todispose)
* [value$](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#value$)
* [kind](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#kind)

### Accessors

* [children](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#children)
* [disposed](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#disposed)
* [hash](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#hash)
* [kind](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#kind-1)
* [list](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#list)
* [version](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#version)

### Methods

* [dispatchGlobalEvent](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#dispatchglobalevent)
* [dispose](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#dispose)
* [fireChange](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#firechange)
* [fromJSON](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#fromjson)
* [subscribe](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#subscribe)
* [toJSON](/en/auto-docs/fixed-layout-editor/classes/ListNode.md#tojson)
...
`get` **list**(): [`ASTNode`](/en/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`any`, `any`>\[]
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`ListNodeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/ListNodeJSON.md) | The `ListNodeJSON` to deserialize. |
...
| Name | Type |
| :------ | :------ |
| `Data` | [`ListNode`](/en/auto-docs/fixed-layout-editor/classes/ListNode.md) |
...
| `selector?` | `SubscribeConfig`<[`ListNode`](/en/auto-docs/fixed-layout-editor/classes/ListNode.md), `Data`> | Listens for specified data. |
