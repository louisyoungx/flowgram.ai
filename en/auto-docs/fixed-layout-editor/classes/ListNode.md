...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`ListNodeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/ListNodeJSON.md) | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`ListNode`](/en/auto-docs/fixed-layout-editor/classes/ListNode.md), `Data`> | 监听指定数据 |
