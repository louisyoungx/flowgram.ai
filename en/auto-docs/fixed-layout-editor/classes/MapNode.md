...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`MapNodeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/MapNodeJSON.md) | AST JSON 数据 |
...
**get**(`key`): `undefined` | [`ASTNode`](/en/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`any`, `any`>
...
| `nextJSON` | [`ASTNodeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/ASTNodeJSON.md) | - |
...
| `selector?` | `SubscribeConfig`<[`MapNode`](/en/auto-docs/fixed-layout-editor/classes/MapNode.md), `Data`> | 监听指定数据 |
