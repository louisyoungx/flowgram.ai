...
* [`ASTNode`](/en/auto-docs/fixed-layout-editor/classes/ASTNode.md)<[`MapNodeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/MapNodeJSON.md)>
...
* [constructor](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#constructor)

### Properties

* [changeLocked](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#changelocked)
* [flags](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#flags)
* [key](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#key)
* [onDispose](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#ondispose)
* [opts](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#opts)
* [parent](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#parent)
* [scope](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#scope)
* [toDispose](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#todispose)
* [value$](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#value$)
* [kind](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#kind)

### Accessors

* [children](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#children)
* [disposed](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#disposed)
* [hash](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#hash)
* [kind](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#kind-1)
* [version](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#version)

### Methods

* [dispatchGlobalEvent](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#dispatchglobalevent)
* [dispose](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#dispose)
* [fireChange](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#firechange)
* [fromJSON](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#fromjson)
* [get](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#get)
* [remove](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#remove)
* [set](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#set)
* [subscribe](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#subscribe)
* [toJSON](/en/auto-docs/fixed-layout-editor/classes/MapNode.md#tojson)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`MapNodeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/MapNodeJSON.md) | The `MapNodeJSON` to deserialize. |
...
| Name | Type |
| :------ | :------ |
| `Node` | extends [`ASTNode`](/en/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`any`, `Node`> = [`ASTNode`](/en/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`any`> |
...
| :------ | :------ | :------ |
| `key` | `string` | The key of the node. |
| `nextJSON` | [`ASTNodeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/ASTNodeJSON.md) | The JSON representation of the node. |
...
| Name | Type |
| :------ | :------ |
| `Data` | [`MapNode`](/en/auto-docs/fixed-layout-editor/classes/MapNode.md) |
...
| `selector?` | `SubscribeConfig`<[`MapNode`](/en/auto-docs/fixed-layout-editor/classes/MapNode.md), `Data`> | Listens for specified data. |
...
| `map` | \[`string`, [`ASTNode`](/en/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`any`>]\[] |
