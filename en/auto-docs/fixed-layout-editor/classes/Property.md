...
| `selector?` | `SubscribeConfig`<[`Property`](/en/auto-docs/fixed-layout-editor/classes/Property.md)<`VariableMeta`>, `Data`> | 监听指定数据 |
...
| Name | Type |
| :------ | :------ |
| `nextInitializer?` | [`ASTNodeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/ASTNodeJSON.md) |
