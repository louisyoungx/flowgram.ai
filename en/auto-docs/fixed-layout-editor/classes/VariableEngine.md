...
| Name | Type |
| :------ | :------ |
| `chain` | [`ScopeChain`](/en/auto-docs/fixed-layout-editor/classes/ScopeChain.md) |
| `astRegisters` | [`ASTRegisters`](/en/auto-docs/fixed-layout-editor/classes/ASTRegisters.md) |
...
| Name | Type |
| :------ | :------ |
| `event` | [`GlobalEventActionType`](/en/auto-docs/fixed-layout-editor/interfaces/GlobalEventActionType.md)<`string`, `any`, [`ASTNode`](/en/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`any`, `any`>> |
...
**getAllScopes**(`«destructured»?`): [`Scope`](/en/auto-docs/fixed-layout-editor/classes/Scope.md)<`Record`<`string`, `any`>>\[]
