...
* [service](/en/auto-docs/fixed-layout-editor/classes/FlowDragLayer.md#service)
...
* [autorun](/en/auto-docs/fixed-layout-editor/classes/FlowDragLayer.md#autorun)
...
`Readonly` **service**: [`FlowDragService`](/en/auto-docs/fixed-layout-editor/classes/FlowDragService.md)
...
| `e.clientY` | `number` |
| `«destructured»` | `Object` |
| › `dragEntities?` | [`FlowNodeEntity`](/en/auto-docs/fixed-layout-editor/classes/FlowNodeEntity-1.md)\[] |
| › `dragStartEntity` | [`FlowNodeEntity`](/en/auto-docs/fixed-layout-editor/classes/FlowNodeEntity-1.md) |
| `options?` | `Object` |
