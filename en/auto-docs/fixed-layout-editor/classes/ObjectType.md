...
* [`BaseType`](/en/auto-docs/fixed-layout-editor/classes/BaseType.md)<[`ObjectJSON`](/en/auto-docs/fixed-layout-editor/interfaces/ObjectJSON.md)>
...
* [constructor](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#constructor)

### Properties

* [changeLocked](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#changelocked)
* [flags](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#flags)
* [key](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#key)
* [onDispose](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#ondispose)
* [opts](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#opts)
* [parent](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#parent)
* [properties](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#properties)
* [propertyTable](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#propertytable)
* [scope](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#scope)
* [toDispose](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#todispose)
* [value$](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#value$)
* [kind](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#kind)

### Accessors

* [children](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#children)
* [disposed](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#disposed)
* [hash](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#hash)
* [kind](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#kind-1)
* [version](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#version)

### Methods

* [dispatchGlobalEvent](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#dispatchglobalevent)
* [dispose](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#dispose)
* [fireChange](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#firechange)
* [fromJSON](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#fromjson)
* [getByKeyPath](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#getbykeypath)
* [isTypeEqual](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#istypeequal)
* [subscribe](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#subscribe)
* [toJSON](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md#tojson)
...
**properties**: [`Property`](/en/auto-docs/fixed-layout-editor/classes/Property.md)<`any`>\[]
...
**propertyTable**: `Map`<`string`, [`Property`](/en/auto-docs/fixed-layout-editor/classes/Property.md)<`any`>>
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`ObjectJSON`](/en/auto-docs/fixed-layout-editor/interfaces/ObjectJSON.md)<`any`> | The `ObjectJSON` to deserialize. |
...
**getByKeyPath**(`keyPath`): `undefined` | [`Property`](/en/auto-docs/fixed-layout-editor/classes/Property.md)<`any`>
...
`undefined` | [`Property`](/en/auto-docs/fixed-layout-editor/classes/Property.md)<`any`>
...
| Name | Type |
| :------ | :------ |
| `Data` | [`ObjectType`](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md) |
...
| `selector?` | `SubscribeConfig`<[`ObjectType`](/en/auto-docs/fixed-layout-editor/classes/ObjectType.md), `Data`> | Listens for specified data. |
