...
* [\_returnType](/en/auto-docs/fixed-layout-editor/classes/KeyPathExpression.md#_returntype)
...
* [getReturnTypeJSONByRef](/en/auto-docs/fixed-layout-editor/classes/KeyPathExpression.md#getreturntypejsonbyref)
...
**\_returnType**: [`BaseType`](/en/auto-docs/fixed-layout-editor/classes/BaseType.md)<`any`>
...
`get` **returnType**(): [`BaseType`](/en/auto-docs/fixed-layout-editor/classes/BaseType.md)<`any`>

The return type of the expression.

#### Returns

[`BaseType`](/en/auto-docs/fixed-layout-editor/classes/BaseType.md)<`any`>
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `_ref` | `undefined` | [`BaseVariableField`](/en/auto-docs/fixed-layout-editor/classes/BaseVariableField.md)<`any`> | The referenced variable field. |
...
| `selector?` | `SubscribeConfig`<[`KeyPathExpression`](/en/auto-docs/fixed-layout-editor/classes/KeyPathExpression.md)<`CustomPathJSON`>, `Data`> | Listens for specified data. |
