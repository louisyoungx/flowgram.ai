...
* [`EntityData`](/en/auto-docs/fixed-layout-editor/classes/EntityData.md)<[`RotationSchema`](/en/auto-docs/fixed-layout-editor/types/RotationSchema.md)>
...
* [constructor](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#constructor)

### Properties

* [entity](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#entity)
* [onDataChange](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#ondatachange)
* [onWillChange](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#onwillchange)
* [opts](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#opts)
* [toDispose](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#todispose)
* [type](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#type)

### Accessors

* [changeLocked](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#changelocked)
* [data](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#data)
* [disposed](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#disposed)
* [onDispose](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#ondispose)
* [type](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#type-1)
* [version](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#version)

### Methods

* [checkChanged](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#checkchanged)
* [dispose](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#dispose)
* [fireChange](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#firechange)
* [fireWillChange](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#firewillchange)
* [fromJSON](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#fromjson)
* [fullyUpdate](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#fullyupdate)
* [getDefaultData](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#getdefaultdata)
* [toJSON](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#tojson)
* [update](/en/auto-docs/fixed-layout-editor/classes/RotationData.md#update)
...
`Readonly` **onDataChange**: [`Event`](/en/auto-docs/fixed-layout-editor/interfaces/Event-1.md)<[`EntityData`](/en/auto-docs/fixed-layout-editor/classes/EntityData.md)<`number`, {}>>
...
`Readonly` **onWillChange**: [`Event`](/en/auto-docs/fixed-layout-editor/interfaces/Event-1.md)<[`EntityData`](/en/auto-docs/fixed-layout-editor/classes/EntityData.md)<`number`, {}>>
