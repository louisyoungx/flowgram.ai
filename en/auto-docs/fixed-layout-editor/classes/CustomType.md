...
* [`BaseType`](/en/auto-docs/fixed-layout-editor/classes/BaseType.md)<[`CustomTypeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/CustomTypeJSON.md)>
...
* [constructor](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#constructor)

### Properties

* [changeLocked](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#changelocked)
* [flags](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#flags)
* [key](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#key)
* [onDispose](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#ondispose)
* [opts](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#opts)
* [parent](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#parent)
* [scope](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#scope)
* [toDispose](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#todispose)
* [value$](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#value$)
* [kind](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#kind)

### Accessors

* [children](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#children)
* [disposed](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#disposed)
* [hash](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#hash)
* [kind](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#kind-1)
* [typeName](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#typename)
* [version](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#version)

### Methods

* [dispatchGlobalEvent](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#dispatchglobalevent)
* [dispose](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#dispose)
* [fireChange](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#firechange)
* [fromJSON](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#fromjson)
* [getByKeyPath](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#getbykeypath)
* [isTypeEqual](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#istypeequal)
* [subscribe](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#subscribe)
* [toJSON](/en/auto-docs/fixed-layout-editor/classes/CustomType.md#tojson)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`CustomTypeJSON`](/en/auto-docs/fixed-layout-editor/interfaces/CustomTypeJSON.md) | The `CustomTypeJSON` to deserialize. |
...
| Name | Type |
| :------ | :------ |
| `Data` | [`CustomType`](/en/auto-docs/fixed-layout-editor/classes/CustomType.md) |
...
| `selector?` | `SubscribeConfig`<[`CustomType`](/en/auto-docs/fixed-layout-editor/classes/CustomType.md), `Data`> | Listens for specified data. |
