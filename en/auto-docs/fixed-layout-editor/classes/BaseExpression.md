...
* [`ASTNode`](/en/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`JSON`, `InjectOpts`>
  ...
  ↳↳ [`EnumerateExpression`](/en/auto-docs/fixed-layout-editor/classes/EnumerateExpression.md)

  ↳↳ [`KeyPathExpression`](/en/auto-docs/fixed-layout-editor/classes/KeyPathExpression.md)

  ↳↳ [`LegacyKeyPathExpression`](/en/auto-docs/fixed-layout-editor/classes/LegacyKeyPathExpression.md)

  ↳↳ [`WrapArrayExpression`](/en/auto-docs/fixed-layout-editor/classes/WrapArrayExpression.md)

## Table of contents

### Constructors

* [constructor](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#constructor)

### Properties

* [changeLocked](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#changelocked)
* [flags](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#flags)
* [key](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#key)
* [onDispose](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#ondispose)
* [opts](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#opts)
* [parent](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#parent)
* [refs$](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#refs$)
* [returnType](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#returntype)
* [scope](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#scope)
* [toDispose](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#todispose)
* [value$](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#value$)
* [kind](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#kind)

### Accessors

* [children](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#children)
* [disposed](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#disposed)
* [globalVariableTable](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#globalvariabletable)
* [hash](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#hash)
* [kind](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#kind-1)
* [parentFields](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#parentfields)
* [refs](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#refs)
* [version](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#version)

### Methods

* [dispatchGlobalEvent](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#dispatchglobalevent)
* [dispose](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#dispose)
* [fireChange](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#firechange)
* [fromJSON](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#fromjson)
* [getRefFields](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#getreffields)
* [refreshRefs](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#refreshrefs)
* [subscribe](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#subscribe)
* [toJSON](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md#tojson)
...
`Abstract` **returnType**: `undefined` | [`BaseType`](/en/auto-docs/fixed-layout-editor/classes/BaseType.md)<`any`, `any`>
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseExpression`](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md)<`JSON`, `InjectOpts`> |
...
| `selector?` | `SubscribeConfig`<[`BaseExpression`](/en/auto-docs/fixed-layout-editor/classes/BaseExpression.md)<`JSON`, `InjectOpts`>, `Data`> | Listens for specified data. |
