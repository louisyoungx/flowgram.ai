...
* [isNodeEnd](/en/auto-docs/fixed-layout-editor/classes/FlowNodeEntity-1.md#isnodeend)
...
`get` **onExtInfoChange**(): [`Event`](/en/auto-docs/fixed-layout-editor/interfaces/Event-1.md)<{ `newInfo`: `any` ; `oldInfo`: `any`  }>
