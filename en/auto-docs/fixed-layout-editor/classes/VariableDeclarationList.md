...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`VariableDeclarationListJSON`](/en/auto-docs/fixed-layout-editor/interfaces/VariableDeclarationListJSON.md)<`any`> | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`VariableDeclarationList`](/en/auto-docs/fixed-layout-editor/classes/VariableDeclarationList.md), `Data`> | 监听指定数据 |
