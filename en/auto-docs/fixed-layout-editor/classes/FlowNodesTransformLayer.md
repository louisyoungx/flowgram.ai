...
* [`Layer`](/en/auto-docs/fixed-layout-editor/classes/Layer.md)<[`FlowNodesTransformLayerOptions`](/en/auto-docs/fixed-layout-editor/interfaces/FlowNodesTransformLayerOptions.md)>
...
* [constructor](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#constructor)

### Properties

* [\_transforms](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#_transforms)
* [config](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#config)
* [context](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#context)
* [document](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#document)
* [documentTransformer](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#documenttransformer)
* [entityManager](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#entitymanager)
* [getOtherLayer](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#getotherlayer)
* [isFocused](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#isfocused)
* [listenGlobalEvent](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#listenglobalevent)
* [listenPlaygroundEvent](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#listenplaygroundevent)
* [node](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#node)
* [observeManager](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#observemanager)
* [options](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#options)
* [pipelineNode](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#pipelinenode)
* [playgroundNode](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#playgroundnode)
* [reloadEntities](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#reloadentities)
* [renderWithReactMemo](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#renderwithreactmemo)
* [resizeObserver](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#resizeobserver)

### Accessors

* [transformVisibles](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#transformvisibles)
* [visibeBounds](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#visibebounds)

### Methods

* [autorun](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#autorun)
* [createDOMCache](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#createdomcache)
* [dispose](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#dispose)
* [getPosFromMouseEvent](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#getposfrommouseevent)
* [onBlur](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#onblur)
* [onFocus](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#onfocus)
* [onReadonlyOrDisabledChange](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#onreadonlyordisabledchange)
* [onReady](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#onready)
* [onResize](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#onresize)
* [onScroll](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#onscroll)
* [onViewportChange](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#onviewportchange)
* [onZoom](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#onzoom)
* [render](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#render)
* [updateNodesBounds](/en/auto-docs/fixed-layout-editor/classes/FlowNodesTransformLayer.md#updatenodesbounds)
...
**options**: [`FlowNodesTransformLayerOptions`](/en/auto-docs/fixed-layout-editor/interfaces/FlowNodesTransformLayerOptions.md)
...
`get` **transformVisibles**(): [`FlowNodeTransformData`](/en/auto-docs/fixed-layout-editor/classes/FlowNodeTransformData.md)\[]
...
`get` **visibeBounds**(): [`Rectangle`](/en/auto-docs/fixed-layout-editor/classes/Rectangle-1.md)\[]
