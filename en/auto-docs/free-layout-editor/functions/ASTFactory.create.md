...
[ASTFactory](/en/auto-docs/free-layout-editor/modules/ASTFactory.md).create
...
| :------ | :------ | :------ |
| `targetType` | (...`args`: `any`\[]) => [`ASTNode`](/en/auto-docs/free-layout-editor/classes/ASTNode.md)<`JSON`, `any`> | Target ASTNode class. |
