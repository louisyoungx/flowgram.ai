...
**\_returnType**: [`BaseType`](/en/auto-docs/free-layout-editor/classes/BaseType.md)<`any`>
...
`get` **returnType**(): [`BaseType`](/en/auto-docs/free-layout-editor/classes/BaseType.md)<`any`>
