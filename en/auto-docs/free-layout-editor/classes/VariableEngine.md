...
| Name | Type |
| :------ | :------ |
| `chain` | [`ScopeChain`](/en/auto-docs/free-layout-editor/classes/ScopeChain.md) |
| `astRegisters` | [`ASTRegisters`](/en/auto-docs/free-layout-editor/classes/ASTRegisters.md) |
...
| Name | Type |
| :------ | :------ |
| `event` | [`GlobalEventActionType`](/en/auto-docs/free-layout-editor/interfaces/GlobalEventActionType.md)<`string`, `any`, [`ASTNode`](/en/auto-docs/free-layout-editor/classes/ASTNode.md)<`any`, `any`>> |
...
**getAllScopes**(`«destructured»?`): [`Scope`](/en/auto-docs/free-layout-editor/classes/Scope.md)<`Record`<`string`, `any`>>\[]
