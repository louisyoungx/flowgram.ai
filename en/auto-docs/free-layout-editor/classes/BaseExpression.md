...
`Abstract` **returnType**: `undefined` | [`BaseType`](/en/auto-docs/free-layout-editor/classes/BaseType.md)<`any`>
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseExpression`](/en/auto-docs/free-layout-editor/classes/BaseExpression.md)<`JSON`> |
...
| `selector?` | `SubscribeConfig`<[`BaseExpression`](/en/auto-docs/free-layout-editor/classes/BaseExpression.md)<`JSON`>, `Data`> | Listens for specified data. |
