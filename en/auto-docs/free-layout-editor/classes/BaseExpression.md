...
* [`ASTNode`](/en/auto-docs/free-layout-editor/classes/ASTNode.md)<`JSON`, `InjectOpts`>
  ...
  ↳↳ [`KeyPathExpressionV2`](/en/auto-docs/free-layout-editor/classes/KeyPathExpressionV2.md)
...
| `selector?` | `SubscribeConfig`<[`BaseExpression`](/en/auto-docs/free-layout-editor/classes/BaseExpression.md)<`JSON`, `InjectOpts`>, `Data`> | 监听指定数据 |
