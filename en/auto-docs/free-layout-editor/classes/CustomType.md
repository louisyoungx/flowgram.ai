...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`CustomTypeJSON`](/en/auto-docs/free-layout-editor/interfaces/CustomTypeJSON.md) | The `CustomTypeJSON` to deserialize. |
...
| `selector?` | `SubscribeConfig`<[`CustomType`](/en/auto-docs/free-layout-editor/classes/CustomType.md), `Data`> | Listens for specified data. |
