...
**items**: [`BaseType`](/en/auto-docs/free-layout-editor/classes/BaseType.md)<`any`, `any`>
...
| `selector?` | `SubscribeConfig`<[`ArrayType`](/en/auto-docs/free-layout-editor/classes/ArrayType.md), `Data`> | 监听指定数据 |
