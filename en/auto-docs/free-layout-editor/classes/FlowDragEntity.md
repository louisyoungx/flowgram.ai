...
* [updateData](/en/auto-docs/free-layout-editor/classes/FlowDragEntity.md#updatedata)
...
**isCollision**(`transition`, `rect`, `isBranch`): [`CollisionRetType`](/en/auto-docs/free-layout-editor/interfaces/CollisionRetType.md)
