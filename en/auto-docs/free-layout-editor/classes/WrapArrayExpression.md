...
`get` **wrapFor**(): `undefined` | [`BaseExpression`](/en/auto-docs/free-layout-editor/classes/BaseExpression.md)<`any`>
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`WrapArrayExpressionJSON`](/en/auto-docs/free-layout-editor/interfaces/WrapArrayExpressionJSON.md) | The `WrapArrayExpressionJSON` to deserialize. |
...
| `selector?` | `SubscribeConfig`<[`WrapArrayExpression`](/en/auto-docs/free-layout-editor/classes/WrapArrayExpression.md), `Data`> | Listens for specified data. |
