...
`get` **enumerateFor**(): `undefined` | [`BaseExpression`](/en/auto-docs/free-layout-editor/classes/BaseExpression.md)<`any`, `any`>
...
| :------ | :------ | :------ |
| `«destructured»` | [`EnumerateExpressionJSON`](/en/auto-docs/free-layout-editor/interfaces/EnumerateExpressionJSON.md) | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`EnumerateExpression`](/en/auto-docs/free-layout-editor/classes/EnumerateExpression.md), `Data`> | 监听指定数据 |
