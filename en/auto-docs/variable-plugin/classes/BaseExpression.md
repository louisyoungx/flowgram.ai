...
* [`ASTNode`](/en/auto-docs/variable-plugin/classes/ASTNode.md)<`JSON`>
  ...
  ↳↳ [`LegacyKeyPathExpression`](/en/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md)
...
`Abstract` **returnType**: `undefined` | [`BaseType`](/en/auto-docs/variable-plugin/classes/BaseType.md)<`any`>
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseExpression`](/en/auto-docs/variable-plugin/classes/BaseExpression.md)<`JSON`> |
...
| `selector?` | `SubscribeConfig`<[`BaseExpression`](/en/auto-docs/variable-plugin/classes/BaseExpression.md)<`JSON`>, `Data`> | Listens for specified data. |
