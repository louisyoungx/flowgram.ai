...
| :------ | :------ | :------ |
| `«destructured»` | [`EnumerateExpressionJSON`](/en/auto-docs/variable-plugin/interfaces/EnumerateExpressionJSON.md) | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`EnumerateExpression`](/en/auto-docs/variable-plugin/classes/EnumerateExpression.md), `Data`> | 监听指定数据 |
