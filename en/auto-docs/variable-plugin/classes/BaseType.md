...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseType`](/en/auto-docs/variable-plugin/classes/BaseType.md)<`JSON`, `InjectOpts`> |
...
| `selector?` | `SubscribeConfig`<[`BaseType`](/en/auto-docs/variable-plugin/classes/BaseType.md)<`JSON`, `InjectOpts`>, `Data`> | Listens for specified data. |
