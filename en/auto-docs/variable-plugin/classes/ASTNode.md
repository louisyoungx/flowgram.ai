...
| Name | Type |
| :------ | :------ |
| `Data` | [`ASTNode`](/en/auto-docs/variable-plugin/classes/ASTNode.md)<`JSON`> |
...
| `selector?` | `SubscribeConfig`<[`ASTNode`](/en/auto-docs/variable-plugin/classes/ASTNode.md)<`JSON`>, `Data`> | Listens for specified data. |
