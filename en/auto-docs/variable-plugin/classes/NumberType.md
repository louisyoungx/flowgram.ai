...
* [constructor](/en/auto-docs/variable-plugin/classes/NumberType.md#constructor)

### Properties

* [changeLocked](/en/auto-docs/variable-plugin/classes/NumberType.md#changelocked)
* [flags](/en/auto-docs/variable-plugin/classes/NumberType.md#flags)
* [key](/en/auto-docs/variable-plugin/classes/NumberType.md#key)
* [onDispose](/en/auto-docs/variable-plugin/classes/NumberType.md#ondispose)
* [opts](/en/auto-docs/variable-plugin/classes/NumberType.md#opts)
* [parent](/en/auto-docs/variable-plugin/classes/NumberType.md#parent)
* [scope](/en/auto-docs/variable-plugin/classes/NumberType.md#scope)
* [toDispose](/en/auto-docs/variable-plugin/classes/NumberType.md#todispose)
* [value$](/en/auto-docs/variable-plugin/classes/NumberType.md#value$)
* [kind](/en/auto-docs/variable-plugin/classes/NumberType.md#kind)

### Accessors

* [children](/en/auto-docs/variable-plugin/classes/NumberType.md#children)
* [disposed](/en/auto-docs/variable-plugin/classes/NumberType.md#disposed)
* [hash](/en/auto-docs/variable-plugin/classes/NumberType.md#hash)
* [kind](/en/auto-docs/variable-plugin/classes/NumberType.md#kind-1)
* [version](/en/auto-docs/variable-plugin/classes/NumberType.md#version)

### Methods

* [dispatchGlobalEvent](/en/auto-docs/variable-plugin/classes/NumberType.md#dispatchglobalevent)
* [dispose](/en/auto-docs/variable-plugin/classes/NumberType.md#dispose)
* [fireChange](/en/auto-docs/variable-plugin/classes/NumberType.md#firechange)
* [fromJSON](/en/auto-docs/variable-plugin/classes/NumberType.md#fromjson)
* [getByKeyPath](/en/auto-docs/variable-plugin/classes/NumberType.md#getbykeypath)
* [isTypeEqual](/en/auto-docs/variable-plugin/classes/NumberType.md#istypeequal)
* [subscribe](/en/auto-docs/variable-plugin/classes/NumberType.md#subscribe)
* [toJSON](/en/auto-docs/variable-plugin/classes/NumberType.md#tojson)
...
| Name | Type |
| :------ | :------ |
| `Data` | [`NumberType`](/en/auto-docs/variable-plugin/classes/NumberType.md) |
...
| `selector?` | `SubscribeConfig`<[`NumberType`](/en/auto-docs/variable-plugin/classes/NumberType.md), `Data`> | Listens for specified data. |
