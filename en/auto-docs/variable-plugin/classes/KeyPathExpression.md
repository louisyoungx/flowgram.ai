...
| Name | Type |
| :------ | :------ |
| `CustomPathJSON` | extends [`ASTNodeJSON`](/en/auto-docs/variable-plugin/interfaces/ASTNodeJSON.md) = [`KeyPathExpressionJSON`](/en/auto-docs/variable-plugin/interfaces/KeyPathExpressionJSON.md) |
...
* [constructor](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#constructor)

### Properties

* [\_returnType](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#_returntype)
* [changeLocked](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#changelocked)
* [flags](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#flags)
* [key](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#key)
* [onDispose](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#ondispose)
* [opts](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#opts)
* [parent](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#parent)
* [refs$](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#refs$)
* [scope](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#scope)
* [toDispose](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#todispose)
* [value$](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#value$)
* [kind](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#kind)

### Accessors

* [children](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#children)
* [disposed](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#disposed)
* [globalVariableTable](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#globalvariabletable)
* [hash](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#hash)
* [keyPath](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#keypath)
* [kind](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#kind-1)
* [parentFields](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#parentfields)
* [refs](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#refs)
* [returnType](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#returntype)
* [version](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#version)

### Methods

* [dispatchGlobalEvent](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#dispatchglobalevent)
* [dispose](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#dispose)
* [fireChange](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#firechange)
* [fromJSON](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#fromjson)
* [getRefFields](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#getreffields)
* [getReturnTypeJSONByRef](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#getreturntypejsonbyref)
* [refreshRefs](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#refreshrefs)
* [subscribe](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#subscribe)
* [toJSON](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md#tojson)
...
**\_returnType**: [`BaseType`](/en/auto-docs/variable-plugin/classes/BaseType.md)<`any`>
...
`get` **returnType**(): [`BaseType`](/en/auto-docs/variable-plugin/classes/BaseType.md)<`any`>
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `_ref` | `undefined` | [`BaseVariableField`](/en/auto-docs/variable-plugin/classes/BaseVariableField.md)<`any`> | The referenced variable field. |
...
| Name | Type |
| :------ | :------ |
| `Data` | [`KeyPathExpression`](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md)<`CustomPathJSON`> |
...
| `selector?` | `SubscribeConfig`<[`KeyPathExpression`](/en/auto-docs/variable-plugin/classes/KeyPathExpression.md)<`CustomPathJSON`>, `Data`> | Listens for specified data. |
