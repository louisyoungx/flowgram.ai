...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`ObjectJSON`](/en/auto-docs/variable-plugin/interfaces/ObjectJSON.md)<`any`> | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`ObjectType`](/en/auto-docs/variable-plugin/classes/ObjectType.md), `Data`> | 监听指定数据 |
