...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`WrapArrayExpressionJSON`](/auto-docs/editor/interfaces/WrapArrayExpressionJSON.md) | The `WrapArrayExpressionJSON` to deserialize. |
...
| `selector?` | `SubscribeConfig`<[`WrapArrayExpression`](/auto-docs/editor/classes/WrapArrayExpression.md), `Data`> | Listens for specified data. |
