...
`get` **list**(): [`ASTNode`](/auto-docs/editor/classes/ASTNode.md)<`any`>\[]
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`ListNodeJSON`](/auto-docs/editor/interfaces/ListNodeJSON.md) | The `ListNodeJSON` to deserialize. |
...
| `selector?` | `SubscribeConfig`<[`ListNode`](/auto-docs/editor/classes/ListNode.md), `Data`> | Listens for specified data. |
