...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`CustomTypeJSON`](/auto-docs/editor/interfaces/CustomTypeJSON.md) | The `CustomTypeJSON` to deserialize. |
...
| `selector?` | `SubscribeConfig`<[`CustomType`](/auto-docs/editor/classes/CustomType.md), `Data`> | Listens for specified data. |
