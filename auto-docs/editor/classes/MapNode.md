...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`MapNodeJSON`](/auto-docs/editor/interfaces/MapNodeJSON.md) | AST JSON 数据 |
...
**get**(`key`): `undefined` | [`ASTNode`](/auto-docs/editor/classes/ASTNode.md)<`any`, `any`>
...
| `nextJSON` | [`ASTNodeJSON`](/auto-docs/editor/interfaces/ASTNodeJSON.md) | - |
...
| `selector?` | `SubscribeConfig`<[`MapNode`](/auto-docs/editor/classes/MapNode.md), `Data`> | 监听指定数据 |
