...
* [`ASTNode`](/auto-docs/editor/classes/ASTNode.md)<`BaseVariableFieldJSON`<`VariableMeta`>>

  ↳ **`BaseVariableField`**

  ↳↳ [`Property`](/auto-docs/editor/classes/Property.md)
...
* [constructor](/auto-docs/editor/classes/BaseVariableField.md#constructor)

### Properties

* [changeLocked](/auto-docs/editor/classes/BaseVariableField.md#changelocked)
* [flags](/auto-docs/editor/classes/BaseVariableField.md#flags)
* [key](/auto-docs/editor/classes/BaseVariableField.md#key)
* [onDispose](/auto-docs/editor/classes/BaseVariableField.md#ondispose)
* [opts](/auto-docs/editor/classes/BaseVariableField.md#opts)
* [parent](/auto-docs/editor/classes/BaseVariableField.md#parent)
* [scope](/auto-docs/editor/classes/BaseVariableField.md#scope)
* [toDispose](/auto-docs/editor/classes/BaseVariableField.md#todispose)
* [value$](/auto-docs/editor/classes/BaseVariableField.md#value$)
* [kind](/auto-docs/editor/classes/BaseVariableField.md#kind)

### Accessors

* [children](/auto-docs/editor/classes/BaseVariableField.md#children)
* [disposed](/auto-docs/editor/classes/BaseVariableField.md#disposed)
* [hash](/auto-docs/editor/classes/BaseVariableField.md#hash)
* [initializer](/auto-docs/editor/classes/BaseVariableField.md#initializer)
* [keyPath](/auto-docs/editor/classes/BaseVariableField.md#keypath)
* [kind](/auto-docs/editor/classes/BaseVariableField.md#kind-1)
* [meta](/auto-docs/editor/classes/BaseVariableField.md#meta)
* [parentFields](/auto-docs/editor/classes/BaseVariableField.md#parentfields)
* [type](/auto-docs/editor/classes/BaseVariableField.md#type)
* [version](/auto-docs/editor/classes/BaseVariableField.md#version)

### Methods

* [dispatchGlobalEvent](/auto-docs/editor/classes/BaseVariableField.md#dispatchglobalevent)
* [dispose](/auto-docs/editor/classes/BaseVariableField.md#dispose)
* [fireChange](/auto-docs/editor/classes/BaseVariableField.md#firechange)
* [fromJSON](/auto-docs/editor/classes/BaseVariableField.md#fromjson)
* [getByKeyPath](/auto-docs/editor/classes/BaseVariableField.md#getbykeypath)
* [onTypeChange](/auto-docs/editor/classes/BaseVariableField.md#ontypechange)
* [subscribe](/auto-docs/editor/classes/BaseVariableField.md#subscribe)
* [toJSON](/auto-docs/editor/classes/BaseVariableField.md#tojson)
* [updateInitializer](/auto-docs/editor/classes/BaseVariableField.md#updateinitializer)
* [updateMeta](/auto-docs/editor/classes/BaseVariableField.md#updatemeta)
* [updateType](/auto-docs/editor/classes/BaseVariableField.md#updatetype)
...
`get` **initializer**(): `undefined` | [`BaseExpression`](/auto-docs/editor/classes/BaseExpression.md)<`any`>
...
`get` **type**(): [`BaseType`](/auto-docs/editor/classes/BaseType.md)<`any`>
...
| Name | Type |
| :------ | :------ |
| `observer` | (`type`: `undefined` | [`ASTNode`](/auto-docs/editor/classes/ASTNode.md)<`any`>) => `void` |
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseVariableField`](/auto-docs/editor/classes/BaseVariableField.md)<`VariableMeta`> |
...
| `selector?` | `SubscribeConfig`<[`BaseVariableField`](/auto-docs/editor/classes/BaseVariableField.md)<`VariableMeta`>, `Data`> | Listens for specified data. |
