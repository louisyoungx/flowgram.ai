...
`get` **enumerateFor**(): `undefined` | [`BaseExpression`](/auto-docs/editor/classes/BaseExpression.md)<`any`>
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`EnumerateExpressionJSON`](/auto-docs/editor/interfaces/EnumerateExpressionJSON.md) | The `EnumerateExpressionJSON` to deserialize. |
...
| `selector?` | `SubscribeConfig`<[`EnumerateExpression`](/auto-docs/editor/classes/EnumerateExpression.md), `Data`> | Listens for specified data. |
