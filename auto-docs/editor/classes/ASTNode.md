...
| Name | Type |
| :------ | :------ |
| `Data` | [`ASTNode`](/auto-docs/editor/classes/ASTNode.md)<`JSON`, `InjectOpts`> |
...
| `selector?` | `SubscribeConfig`<[`ASTNode`](/auto-docs/editor/classes/ASTNode.md)<`JSON`, `InjectOpts`>, `Data`> | Listens for specified data. |
