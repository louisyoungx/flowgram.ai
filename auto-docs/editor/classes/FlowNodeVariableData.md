...
**getPrivateVar**(`key?`): `undefined` | [`ASTNode`](/auto-docs/editor/classes/ASTNode.md)<`any`, `any`>
...
**setPrivateVar**(`key`, `json`): [`ASTNode`](/auto-docs/editor/classes/ASTNode.md)<`any`, `any`>
...
**setPrivateVar**(`json`): [`ASTNode`](/auto-docs/editor/classes/ASTNode.md)<`any`, `any`>
