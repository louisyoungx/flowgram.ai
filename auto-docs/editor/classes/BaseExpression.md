...
* [`ASTNode`](/auto-docs/editor/classes/ASTNode.md)<`JSON`>
  ...
  ↳↳ [`LegacyKeyPathExpression`](/auto-docs/editor/classes/LegacyKeyPathExpression.md)
...
`Abstract` **returnType**: `undefined` | [`BaseType`](/auto-docs/editor/classes/BaseType.md)<`any`>
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseExpression`](/auto-docs/editor/classes/BaseExpression.md)<`JSON`> |
...
| `selector?` | `SubscribeConfig`<[`BaseExpression`](/auto-docs/editor/classes/BaseExpression.md)<`JSON`>, `Data`> | Listens for specified data. |
