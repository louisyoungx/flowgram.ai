...
* [fromNodeJSON](/auto-docs/editor/interfaces/EditorProps-1.md#fromnodejson)
...
`Optional` **shortcuts**: (`shortcutsRegistry`: [`ShortcutsRegistry`](/auto-docs/editor/classes/ShortcutsRegistry.md), `ctx`: `CTX`) => `void`
