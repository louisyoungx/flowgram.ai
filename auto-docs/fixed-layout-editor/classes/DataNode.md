...
* [constructor](/auto-docs/fixed-layout-editor/classes/DataNode.md#constructor)

### Properties

* [changeLocked](/auto-docs/fixed-layout-editor/classes/DataNode.md#changelocked)
* [flags](/auto-docs/fixed-layout-editor/classes/DataNode.md#flags)
* [key](/auto-docs/fixed-layout-editor/classes/DataNode.md#key)
* [onDispose](/auto-docs/fixed-layout-editor/classes/DataNode.md#ondispose)
* [opts](/auto-docs/fixed-layout-editor/classes/DataNode.md#opts)
* [parent](/auto-docs/fixed-layout-editor/classes/DataNode.md#parent)
* [scope](/auto-docs/fixed-layout-editor/classes/DataNode.md#scope)
* [toDispose](/auto-docs/fixed-layout-editor/classes/DataNode.md#todispose)
* [value$](/auto-docs/fixed-layout-editor/classes/DataNode.md#value$)
* [kind](/auto-docs/fixed-layout-editor/classes/DataNode.md#kind)

### Accessors

* [children](/auto-docs/fixed-layout-editor/classes/DataNode.md#children)
* [data](/auto-docs/fixed-layout-editor/classes/DataNode.md#data)
* [disposed](/auto-docs/fixed-layout-editor/classes/DataNode.md#disposed)
* [hash](/auto-docs/fixed-layout-editor/classes/DataNode.md#hash)
* [kind](/auto-docs/fixed-layout-editor/classes/DataNode.md#kind-1)
* [version](/auto-docs/fixed-layout-editor/classes/DataNode.md#version)

### Methods

* [dispatchGlobalEvent](/auto-docs/fixed-layout-editor/classes/DataNode.md#dispatchglobalevent)
* [dispose](/auto-docs/fixed-layout-editor/classes/DataNode.md#dispose)
* [fireChange](/auto-docs/fixed-layout-editor/classes/DataNode.md#firechange)
* [fromJSON](/auto-docs/fixed-layout-editor/classes/DataNode.md#fromjson)
* [partialUpdate](/auto-docs/fixed-layout-editor/classes/DataNode.md#partialupdate)
* [subscribe](/auto-docs/fixed-layout-editor/classes/DataNode.md#subscribe)
* [toJSON](/auto-docs/fixed-layout-editor/classes/DataNode.md#tojson)
...
| Name | Type |
| :------ | :------ |
| `Data` | [`DataNode`](/auto-docs/fixed-layout-editor/classes/DataNode.md)<`Data`> |
...
| `selector?` | `SubscribeConfig`<[`DataNode`](/auto-docs/fixed-layout-editor/classes/DataNode.md)<`Data`>, `Data`> | Listens for specified data. |
...
**toJSON**(): { `kind`: [`ASTKind`](/auto-docs/fixed-layout-editor/enums/ASTKind.md)  } & `Data`

Serialize the `DataNode` to `DataNodeJSON`.

#### Returns

{ `kind`: [`ASTKind`](/auto-docs/fixed-layout-editor/enums/ASTKind.md)  } & `Data`
