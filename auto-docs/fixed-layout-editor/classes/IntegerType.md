...
* [constructor](/auto-docs/fixed-layout-editor/classes/IntegerType.md#constructor)

### Properties

* [changeLocked](/auto-docs/fixed-layout-editor/classes/IntegerType.md#changelocked)
* [flags](/auto-docs/fixed-layout-editor/classes/IntegerType.md#flags)
* [key](/auto-docs/fixed-layout-editor/classes/IntegerType.md#key)
* [onDispose](/auto-docs/fixed-layout-editor/classes/IntegerType.md#ondispose)
* [opts](/auto-docs/fixed-layout-editor/classes/IntegerType.md#opts)
* [parent](/auto-docs/fixed-layout-editor/classes/IntegerType.md#parent)
* [scope](/auto-docs/fixed-layout-editor/classes/IntegerType.md#scope)
* [toDispose](/auto-docs/fixed-layout-editor/classes/IntegerType.md#todispose)
* [value$](/auto-docs/fixed-layout-editor/classes/IntegerType.md#value$)
* [kind](/auto-docs/fixed-layout-editor/classes/IntegerType.md#kind)

### Accessors

* [children](/auto-docs/fixed-layout-editor/classes/IntegerType.md#children)
* [disposed](/auto-docs/fixed-layout-editor/classes/IntegerType.md#disposed)
* [hash](/auto-docs/fixed-layout-editor/classes/IntegerType.md#hash)
* [kind](/auto-docs/fixed-layout-editor/classes/IntegerType.md#kind-1)
* [version](/auto-docs/fixed-layout-editor/classes/IntegerType.md#version)

### Methods

* [dispatchGlobalEvent](/auto-docs/fixed-layout-editor/classes/IntegerType.md#dispatchglobalevent)
* [dispose](/auto-docs/fixed-layout-editor/classes/IntegerType.md#dispose)
* [fireChange](/auto-docs/fixed-layout-editor/classes/IntegerType.md#firechange)
* [fromJSON](/auto-docs/fixed-layout-editor/classes/IntegerType.md#fromjson)
* [getByKeyPath](/auto-docs/fixed-layout-editor/classes/IntegerType.md#getbykeypath)
* [isTypeEqual](/auto-docs/fixed-layout-editor/classes/IntegerType.md#istypeequal)
* [subscribe](/auto-docs/fixed-layout-editor/classes/IntegerType.md#subscribe)
* [toJSON](/auto-docs/fixed-layout-editor/classes/IntegerType.md#tojson)
...
| Name | Type |
| :------ | :------ |
| `Data` | [`IntegerType`](/auto-docs/fixed-layout-editor/classes/IntegerType.md) |
...
| `selector?` | `SubscribeConfig`<[`IntegerType`](/auto-docs/fixed-layout-editor/classes/IntegerType.md), `Data`> | Listens for specified data. |
