...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`MapNodeJSON`](/auto-docs/fixed-layout-editor/interfaces/MapNodeJSON.md) | The `MapNodeJSON` to deserialize. |
...
| :------ | :------ | :------ |
| `key` | `string` | The key of the node. |
| `nextJSON` | [`ASTNodeJSON`](/auto-docs/fixed-layout-editor/interfaces/ASTNodeJSON.md) | The JSON representation of the node. |
...
| `selector?` | `SubscribeConfig`<[`MapNode`](/auto-docs/fixed-layout-editor/classes/MapNode.md), `Data`> | Listens for specified data. |
...
| `map` | \[`string`, [`ASTNode`](/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`any`>]\[] |
