...
`Readonly` **onResize**: [`Event`](/auto-docs/fixed-layout-editor/interfaces/Event-1.md)<[`PipelineDimension`](/auto-docs/fixed-layout-editor/interfaces/PipelineDimension.md)>
