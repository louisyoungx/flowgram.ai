...
* [dispatchGlobalEvent](/auto-docs/fixed-layout-editor/classes/Property.md#dispatchglobalevent)
...
| `selector?` | `SubscribeConfig`<[`Property`](/auto-docs/fixed-layout-editor/classes/Property.md)<`VariableMeta`>, `Data`> | 监听指定数据 |
