...
* [`ASTNode`](/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`BaseVariableFieldJSON`<`VariableMeta`>>

  ↳ **`BaseVariableField`**

  ↳↳ [`Property`](/auto-docs/fixed-layout-editor/classes/Property.md)
...
* [constructor](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#constructor)

### Properties

* [changeLocked](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#changelocked)
* [flags](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#flags)
* [key](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#key)
* [onDispose](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#ondispose)
* [opts](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#opts)
* [parent](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#parent)
* [scope](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#scope)
* [toDispose](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#todispose)
* [value$](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#value$)
* [kind](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#kind)

### Accessors

* [children](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#children)
* [disposed](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#disposed)
* [hash](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#hash)
* [initializer](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#initializer)
* [keyPath](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#keypath)
* [kind](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#kind-1)
* [meta](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#meta)
* [parentFields](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#parentfields)
* [type](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#type)
* [version](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#version)

### Methods

* [dispatchGlobalEvent](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#dispatchglobalevent)
* [dispose](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#dispose)
* [fireChange](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#firechange)
* [fromJSON](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#fromjson)
* [getByKeyPath](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#getbykeypath)
* [onTypeChange](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#ontypechange)
* [subscribe](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#subscribe)
* [toJSON](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#tojson)
* [updateInitializer](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#updateinitializer)
* [updateMeta](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#updatemeta)
* [updateType](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md#updatetype)
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseVariableField`](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md)<`VariableMeta`> |
...
| `selector?` | `SubscribeConfig`<[`BaseVariableField`](/auto-docs/fixed-layout-editor/classes/BaseVariableField.md)<`VariableMeta`>, `Data`> | 监听指定数据 |
...
| Name | Type |
| :------ | :------ |
| `nextInitializer?` | [`ASTNodeJSON`](/auto-docs/fixed-layout-editor/interfaces/ASTNodeJSON.md) |
