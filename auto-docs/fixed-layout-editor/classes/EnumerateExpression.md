...
| :------ | :------ | :------ |
| `«destructured»` | [`EnumerateExpressionJSON`](/auto-docs/fixed-layout-editor/interfaces/EnumerateExpressionJSON.md) | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`EnumerateExpression`](/auto-docs/fixed-layout-editor/classes/EnumerateExpression.md), `Data`> | 监听指定数据 |
