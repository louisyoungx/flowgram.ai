...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseType`](/auto-docs/fixed-layout-editor/classes/BaseType.md)<`JSON`> |
...
| `selector?` | `SubscribeConfig`<[`BaseType`](/auto-docs/fixed-layout-editor/classes/BaseType.md)<`JSON`>, `Data`> | Listens for specified data. |
