...
* [`ASTNode`](/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`JSON`, `InjectOpts`>
  ...
  ↳↳ [`ArrayType`](/auto-docs/fixed-layout-editor/classes/ArrayType.md)

  ↳↳ [`BooleanType`](/auto-docs/fixed-layout-editor/classes/BooleanType.md)

  ↳↳ [`CustomType`](/auto-docs/fixed-layout-editor/classes/CustomType.md)

  ↳↳ [`IntegerType`](/auto-docs/fixed-layout-editor/classes/IntegerType.md)

  ↳↳ [`MapType`](/auto-docs/fixed-layout-editor/classes/MapType.md)

  ↳↳ [`NumberType`](/auto-docs/fixed-layout-editor/classes/NumberType.md)

  ↳↳ [`ObjectType`](/auto-docs/fixed-layout-editor/classes/ObjectType.md)

  ↳↳ [`StringType`](/auto-docs/fixed-layout-editor/classes/StringType.md)

## Table of contents

### Constructors

* [constructor](/auto-docs/fixed-layout-editor/classes/BaseType.md#constructor)

### Properties

* [changeLocked](/auto-docs/fixed-layout-editor/classes/BaseType.md#changelocked)
* [flags](/auto-docs/fixed-layout-editor/classes/BaseType.md#flags)
* [key](/auto-docs/fixed-layout-editor/classes/BaseType.md#key)
* [onDispose](/auto-docs/fixed-layout-editor/classes/BaseType.md#ondispose)
* [opts](/auto-docs/fixed-layout-editor/classes/BaseType.md#opts)
* [parent](/auto-docs/fixed-layout-editor/classes/BaseType.md#parent)
* [scope](/auto-docs/fixed-layout-editor/classes/BaseType.md#scope)
* [toDispose](/auto-docs/fixed-layout-editor/classes/BaseType.md#todispose)
* [value$](/auto-docs/fixed-layout-editor/classes/BaseType.md#value$)
* [kind](/auto-docs/fixed-layout-editor/classes/BaseType.md#kind)

### Accessors

* [children](/auto-docs/fixed-layout-editor/classes/BaseType.md#children)
* [disposed](/auto-docs/fixed-layout-editor/classes/BaseType.md#disposed)
* [hash](/auto-docs/fixed-layout-editor/classes/BaseType.md#hash)
* [kind](/auto-docs/fixed-layout-editor/classes/BaseType.md#kind-1)
* [version](/auto-docs/fixed-layout-editor/classes/BaseType.md#version)

### Methods

* [dispatchGlobalEvent](/auto-docs/fixed-layout-editor/classes/BaseType.md#dispatchglobalevent)
* [dispose](/auto-docs/fixed-layout-editor/classes/BaseType.md#dispose)
* [fireChange](/auto-docs/fixed-layout-editor/classes/BaseType.md#firechange)
* [fromJSON](/auto-docs/fixed-layout-editor/classes/BaseType.md#fromjson)
* [getByKeyPath](/auto-docs/fixed-layout-editor/classes/BaseType.md#getbykeypath)
* [isTypeEqual](/auto-docs/fixed-layout-editor/classes/BaseType.md#istypeequal)
* [subscribe](/auto-docs/fixed-layout-editor/classes/BaseType.md#subscribe)
* [toJSON](/auto-docs/fixed-layout-editor/classes/BaseType.md#tojson)
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseType`](/auto-docs/fixed-layout-editor/classes/BaseType.md)<`JSON`, `InjectOpts`> |
...
| `selector?` | `SubscribeConfig`<[`BaseType`](/auto-docs/fixed-layout-editor/classes/BaseType.md)<`JSON`, `InjectOpts`>, `Data`> | Listens for specified data. |
