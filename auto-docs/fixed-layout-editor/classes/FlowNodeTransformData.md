...
* [outputPoint](/auto-docs/fixed-layout-editor/classes/FlowNodeTransformData.md#outputpoint)
...
`get` **next**(): `undefined` | [`FlowNodeTransformData`](/auto-docs/fixed-layout-editor/classes/FlowNodeTransformData.md)
