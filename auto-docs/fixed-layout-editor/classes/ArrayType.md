...
**items**: [`BaseType`](/auto-docs/fixed-layout-editor/classes/BaseType.md)<`any`, `any`>
...
| `selector?` | `SubscribeConfig`<[`ArrayType`](/auto-docs/fixed-layout-editor/classes/ArrayType.md), `Data`> | 监听指定数据 |
