...
| Name | Type |
| :------ | :------ |
| `Data` | [`ASTNode`](/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`JSON`> |
...
| `selector?` | `SubscribeConfig`<[`ASTNode`](/auto-docs/fixed-layout-editor/classes/ASTNode.md)<`JSON`>, `Data`> | Listens for specified data. |
