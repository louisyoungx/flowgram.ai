...
| Name | Type |
| :------ | :------ |
| `«destructured»` | [`VariableDeclarationJSON`](/auto-docs/fixed-layout-editor/types/VariableDeclarationJSON.md)<`VariableMeta`> |
...
| `selector?` | `SubscribeConfig`<[`VariableDeclaration`](/auto-docs/fixed-layout-editor/classes/VariableDeclaration.md)<`VariableMeta`>, `Data`> | 监听指定数据 |
