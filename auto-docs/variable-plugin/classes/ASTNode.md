...
| Name | Type |
| :------ | :------ |
| `Data` | [`ASTNode`](/auto-docs/variable-plugin/classes/ASTNode.md)<`JSON`> |
...
| `selector?` | `SubscribeConfig`<[`ASTNode`](/auto-docs/variable-plugin/classes/ASTNode.md)<`JSON`>, `Data`> | Listens for specified data. |
