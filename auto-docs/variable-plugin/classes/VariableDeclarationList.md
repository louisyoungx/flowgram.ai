...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`VariableDeclarationListJSON`](/auto-docs/variable-plugin/interfaces/VariableDeclarationListJSON.md)<`any`> | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`VariableDeclarationList`](/auto-docs/variable-plugin/classes/VariableDeclarationList.md), `Data`> | 监听指定数据 |
