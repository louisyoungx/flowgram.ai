...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`ObjectJSON`](/auto-docs/variable-plugin/interfaces/ObjectJSON.md)<`any`> | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`ObjectType`](/auto-docs/variable-plugin/classes/ObjectType.md), `Data`> | 监听指定数据 |
