...
| :------ | :------ | :------ |
| `«destructured»` | [`WrapArrayExpressionJSON`](/auto-docs/variable-plugin/interfaces/WrapArrayExpressionJSON.md) | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`WrapArrayExpression`](/auto-docs/variable-plugin/classes/WrapArrayExpression.md), `Data`> | 监听指定数据 |
