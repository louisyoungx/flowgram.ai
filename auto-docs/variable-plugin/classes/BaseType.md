...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseType`](/auto-docs/variable-plugin/classes/BaseType.md)<`JSON`, `InjectOpts`> |
...
| `selector?` | `SubscribeConfig`<[`BaseType`](/auto-docs/variable-plugin/classes/BaseType.md)<`JSON`, `InjectOpts`>, `Data`> | Listens for specified data. |
