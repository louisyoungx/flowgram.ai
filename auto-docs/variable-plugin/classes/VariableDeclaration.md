...
* [dispatchGlobalEvent](/auto-docs/variable-plugin/classes/VariableDeclaration.md#dispatchglobalevent)
...
| Name | Type |
| :------ | :------ |
| `«destructured»` | [`VariableDeclarationJSON`](/auto-docs/variable-plugin/types/VariableDeclarationJSON.md)<`VariableMeta`> |
...
| `selector?` | `SubscribeConfig`<[`VariableDeclaration`](/auto-docs/variable-plugin/classes/VariableDeclaration.md)<`VariableMeta`>, `Data`> | 监听指定数据 |
