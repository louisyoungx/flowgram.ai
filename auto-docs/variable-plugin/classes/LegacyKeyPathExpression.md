...
* [constructor](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#constructor)

### Properties

* [changeLocked](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#changelocked)
* [flags](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#flags)
* [key](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#key)
* [onDispose](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#ondispose)
* [opts](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#opts)
* [parent](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#parent)
* [refs$](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#refs$)
* [scope](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#scope)
* [toDispose](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#todispose)
* [value$](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#value$)
* [kind](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#kind)

### Accessors

* [children](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#children)
* [disposed](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#disposed)
* [globalVariableTable](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#globalvariabletable)
* [hash](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#hash)
* [keyPath](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#keypath)
* [kind](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#kind-1)
* [parentFields](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#parentfields)
* [refs](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#refs)
* [returnType](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#returntype)
* [version](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#version)

### Methods

* [dispatchGlobalEvent](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#dispatchglobalevent)
* [dispose](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#dispose)
* [fireChange](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#firechange)
* [fromJSON](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#fromjson)
* [getRefFields](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#getreffields)
* [refreshRefs](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#refreshrefs)
* [subscribe](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#subscribe)
* [toJSON](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md#tojson)
...
`get` **returnType**(): `undefined` | [`BaseType`](/auto-docs/variable-plugin/classes/BaseType.md)<`any`>

The return type of the expression.

#### Returns

`undefined` | [`BaseType`](/auto-docs/variable-plugin/classes/BaseType.md)<`any`>
...
| Name | Type |
| :------ | :------ |
| `Data` | [`LegacyKeyPathExpression`](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md)<`CustomPathJSON`> |
...
| `selector?` | `SubscribeConfig`<[`LegacyKeyPathExpression`](/auto-docs/variable-plugin/classes/LegacyKeyPathExpression.md)<`CustomPathJSON`>, `Data`> | Listens for specified data. |
