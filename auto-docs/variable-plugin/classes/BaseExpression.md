...
`Abstract` **returnType**: `undefined` | [`BaseType`](/auto-docs/variable-plugin/classes/BaseType.md)<`any`>
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseExpression`](/auto-docs/variable-plugin/classes/BaseExpression.md)<`JSON`> |
...
| `selector?` | `SubscribeConfig`<[`BaseExpression`](/auto-docs/variable-plugin/classes/BaseExpression.md)<`JSON`>, `Data`> | Listens for specified data. |
