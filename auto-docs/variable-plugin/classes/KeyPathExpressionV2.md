...
| Name | Type |
| :------ | :------ |
| `CustomPathJSON` | extends [`ASTNodeJSON`](/auto-docs/variable-plugin/interfaces/ASTNodeJSON.md) = `KeyPathExpressionJSON` |
...
* [constructor](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#constructor)

### Properties

* [\_returnType](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#_returntype)
* [changeLocked](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#changelocked)
* [flags](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#flags)
* [key](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#key)
* [onDispose](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#ondispose)
* [opts](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#opts)
* [parent](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#parent)
* [refs$](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#refs$)
* [scope](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#scope)
* [toDispose](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#todispose)
* [value$](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#value$)
* [kind](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#kind)

### Accessors

* [children](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#children)
* [disposed](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#disposed)
* [globalVariableTable](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#globalvariabletable)
* [hash](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#hash)
* [keyPath](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#keypath)
* [kind](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#kind-1)
* [parentFields](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#parentfields)
* [refs](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#refs)
* [returnType](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#returntype)
* [version](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#version)

### Methods

* [dispatchGlobalEvent](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#dispatchglobalevent)
* [dispose](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#dispose)
* [fireChange](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#firechange)
* [fromJSON](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#fromjson)
* [getRefFields](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#getreffields)
* [getReturnTypeJSONByRef](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#getreturntypejsonbyref)
* [refreshRefs](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#refreshrefs)
* [subscribe](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#subscribe)
* [toJSON](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md#tojson)
...
`get` **returnType**(): [`BaseType`](/auto-docs/variable-plugin/classes/BaseType.md)<`any`, `any`>
...
| Name | Type |
| :------ | :------ |
| `_ref` | `undefined` | [`BaseVariableField`](/auto-docs/variable-plugin/classes/BaseVariableField.md)<`any`> |
...
| Name | Type |
| :------ | :------ |
| `Data` | [`KeyPathExpressionV2`](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md)<`CustomPathJSON`> |
...
| `selector?` | `SubscribeConfig`<[`KeyPathExpressionV2`](/auto-docs/variable-plugin/classes/KeyPathExpressionV2.md)<`CustomPathJSON`>, `Data`> | 监听指定数据 |
