...
**getVar**(`key?`): `undefined` | [`ASTNode`](/auto-docs/variable-core/classes/ASTNode.md)<`any`, `any`>
...
**setVar**(`json`): [`ASTNode`](/auto-docs/variable-core/classes/ASTNode.md)<`any`, `any`>
...
| :------ | :------ | :------ |
| `json` | [`ASTNodeJSON`](/auto-docs/variable-core/interfaces/ASTNodeJSON.md) | The JSON value to store. |
...
**setVar**(`key`, `json`): [`ASTNode`](/auto-docs/variable-core/classes/ASTNode.md)<`any`, `any`>
