...
| :------ | :------ | :------ |
| `«destructured»` | [`EnumerateExpressionJSON`](/auto-docs/variable-core/interfaces/EnumerateExpressionJSON.md) | AST JSON 数据 |
...
| `selector` | `SubscribeConfig`<[`EnumerateExpression`](/auto-docs/variable-core/classes/EnumerateExpression.md), `Data`> | 监听指定数据 |
