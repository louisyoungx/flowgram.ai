...
* [dispatchGlobalEvent](/auto-docs/variable-core/classes/VariableDeclaration.md#dispatchglobalevent)
...
| Name | Type |
| :------ | :------ |
| `«destructured»` | [`VariableDeclarationJSON`](/auto-docs/variable-core/types/VariableDeclarationJSON.md)<`VariableMeta`> |
...
| `selector` | `SubscribeConfig`<[`VariableDeclaration`](/auto-docs/variable-core/classes/VariableDeclaration.md)<`VariableMeta`>, `Data`> | 监听指定数据 |
