...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`ObjectJSON`](/auto-docs/variable-core/interfaces/ObjectJSON.md)<`any`> | AST JSON 数据 |
...
| `selector` | `SubscribeConfig`<[`ObjectType`](/auto-docs/variable-core/classes/ObjectType.md), `Data`> | 监听指定数据 |
