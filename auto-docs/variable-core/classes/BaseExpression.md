...
* [`ASTNode`](/auto-docs/variable-core/classes/ASTNode.md)<`JSON`>
  ...
  ↳↳ [`LegacyKeyPathExpression`](/auto-docs/variable-core/classes/LegacyKeyPathExpression.md)
...
`Abstract` **returnType**: `undefined` | [`BaseType`](/auto-docs/variable-core/classes/BaseType.md)<`any`>
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseExpression`](/auto-docs/variable-core/classes/BaseExpression.md)<`JSON`> |
...
| `selector` | `SubscribeConfig`<[`BaseExpression`](/auto-docs/variable-core/classes/BaseExpression.md)<`JSON`>, `Data`> | Listens for specified data. |
