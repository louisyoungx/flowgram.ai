...
* [`ASTNode`](/auto-docs/variable-core/classes/ASTNode.md)<`JSON`>

  ↳ **`BaseType`**

  ↳↳ [`StringType`](/auto-docs/variable-core/classes/StringType.md)

  ↳↳ [`IntegerType`](/auto-docs/variable-core/classes/IntegerType.md)

  ↳↳ [`BooleanType`](/auto-docs/variable-core/classes/BooleanType.md)

  ↳↳ [`NumberType`](/auto-docs/variable-core/classes/NumberType.md)

  ↳↳ [`ArrayType`](/auto-docs/variable-core/classes/ArrayType.md)

  ↳↳ [`MapType`](/auto-docs/variable-core/classes/MapType.md)

  ↳↳ [`ObjectType`](/auto-docs/variable-core/classes/ObjectType.md)

  ↳↳ [`CustomType`](/auto-docs/variable-core/classes/CustomType.md)

## Table of contents

### Constructors

* [constructor](/auto-docs/variable-core/classes/BaseType.md#constructor)

### Properties

* [changeLocked](/auto-docs/variable-core/classes/BaseType.md#changelocked)
* [flags](/auto-docs/variable-core/classes/BaseType.md#flags)
* [key](/auto-docs/variable-core/classes/BaseType.md#key)
* [onDispose](/auto-docs/variable-core/classes/BaseType.md#ondispose)
* [opts](/auto-docs/variable-core/classes/BaseType.md#opts)
* [parent](/auto-docs/variable-core/classes/BaseType.md#parent)
* [scope](/auto-docs/variable-core/classes/BaseType.md#scope)
* [toDispose](/auto-docs/variable-core/classes/BaseType.md#todispose)
* [value$](/auto-docs/variable-core/classes/BaseType.md#value$)
* [kind](/auto-docs/variable-core/classes/BaseType.md#kind)

### Accessors

* [children](/auto-docs/variable-core/classes/BaseType.md#children)
* [disposed](/auto-docs/variable-core/classes/BaseType.md#disposed)
* [hash](/auto-docs/variable-core/classes/BaseType.md#hash)
* [kind](/auto-docs/variable-core/classes/BaseType.md#kind-1)
* [version](/auto-docs/variable-core/classes/BaseType.md#version)

### Methods

* [dispatchGlobalEvent](/auto-docs/variable-core/classes/BaseType.md#dispatchglobalevent)
* [dispose](/auto-docs/variable-core/classes/BaseType.md#dispose)
* [fireChange](/auto-docs/variable-core/classes/BaseType.md#firechange)
* [fromJSON](/auto-docs/variable-core/classes/BaseType.md#fromjson)
* [getByKeyPath](/auto-docs/variable-core/classes/BaseType.md#getbykeypath)
* [isTypeEqual](/auto-docs/variable-core/classes/BaseType.md#istypeequal)
* [subscribe](/auto-docs/variable-core/classes/BaseType.md#subscribe)
* [toJSON](/auto-docs/variable-core/classes/BaseType.md#tojson)
...
| Name | Type |
| :------ | :------ |
| `Data` | [`BaseType`](/auto-docs/variable-core/classes/BaseType.md)<`JSON`> |
...
| `selector` | `SubscribeConfig`<[`BaseType`](/auto-docs/variable-core/classes/BaseType.md)<`JSON`>, `Data`> | Listens for specified data. |
