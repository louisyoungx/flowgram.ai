...
* [isMouseFriendlyMode](/auto-docs/playground-react/classes/EditorStateConfigEntity.md#ismousefriendlymode)
...
**onCancel**(`stateId`, `fn`): [`Disposable`](/auto-docs/playground-react/interfaces/Disposable-1.md)
