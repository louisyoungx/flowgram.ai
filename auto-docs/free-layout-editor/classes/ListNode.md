...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`ListNodeJSON`](/auto-docs/free-layout-editor/interfaces/ListNodeJSON.md) | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`ListNode`](/auto-docs/free-layout-editor/classes/ListNode.md), `Data`> | 监听指定数据 |
