...
* [children](/auto-docs/free-layout-editor/classes/VariableDeclarationList.md#children)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`VariableDeclarationListJSON`](/auto-docs/free-layout-editor/interfaces/VariableDeclarationListJSON.md)<`any`> | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`VariableDeclarationList`](/auto-docs/free-layout-editor/classes/VariableDeclarationList.md), `Data`> | 监听指定数据 |
