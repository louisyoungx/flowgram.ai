...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`MapNodeJSON`](/auto-docs/free-layout-editor/interfaces/MapNodeJSON.md) | AST JSON 数据 |
...
**get**(`key`): `undefined` | [`ASTNode`](/auto-docs/free-layout-editor/classes/ASTNode.md)<`any`, `any`>
...
| `nextJSON` | [`ASTNodeJSON`](/auto-docs/free-layout-editor/interfaces/ASTNodeJSON.md) | - |
...
| `selector?` | `SubscribeConfig`<[`MapNode`](/auto-docs/free-layout-editor/classes/MapNode.md), `Data`> | 监听指定数据 |
