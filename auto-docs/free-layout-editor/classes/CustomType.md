...
| Name | Type | Description |
| :------ | :------ | :------ |
| `json` | [`CustomTypeJSON`](/auto-docs/free-layout-editor/interfaces/CustomTypeJSON.md) | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`CustomType`](/auto-docs/free-layout-editor/classes/CustomType.md), `Data`> | 监听指定数据 |
