...
| :------ | :------ | :------ |
| `«destructured»` | [`WrapArrayExpressionJSON`](/auto-docs/free-layout-editor/interfaces/WrapArrayExpressionJSON.md) | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`WrapArrayExpression`](/auto-docs/free-layout-editor/classes/WrapArrayExpression.md), `Data`> | 监听指定数据 |
