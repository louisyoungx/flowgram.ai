...
**items**: [`BaseType`](/auto-docs/free-layout-editor/classes/BaseType.md)<`any`>
...
| `selector?` | `SubscribeConfig`<[`ArrayType`](/auto-docs/free-layout-editor/classes/ArrayType.md), `Data`> | Listens for specified data. |
