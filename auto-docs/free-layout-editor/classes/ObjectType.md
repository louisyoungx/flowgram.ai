...
| Name | Type | Description |
| :------ | :------ | :------ |
| `«destructured»` | [`ObjectJSON`](/auto-docs/free-layout-editor/interfaces/ObjectJSON.md)<`any`> | AST JSON 数据 |
...
| `selector?` | `SubscribeConfig`<[`ObjectType`](/auto-docs/free-layout-editor/classes/ObjectType.md), `Data`> | 监听指定数据 |
