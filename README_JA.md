...
[CodeSandboxで開く](https://codesandbox.io/p/github/louisyoungx/flowgram-demo/main?import=true)
...
| [フォーム](https://flowgram.ai/examples/node-form/basic.html)                                     | 組み込みフォームとフォームは、ノードデータのCRUD操作を維持し、レンダリング、検証、副作用、キャンバス/変数リンケージなどの機能を提供します。 | ![フォーム](https://github.com/user-attachments/assets/13e9b4cd-e993-4d21-901c-fb6cf106de78) |
| [変数](https://flowgram.ai/guide/variable/basic.html)                                             | 宣言型変数は、「コネクタ」と同様の役割を果たします。これらは、異なるノード間で情報を渡すために使用される「メッセンジャー」です。            | ![変数](https://github.com/user-attachments/assets/442006db-25e3-4fb5-972c-7a0545638ff5)     |
...
- [クイックスタート](https://flowgram.ai/guide/getting-started/install.html)
